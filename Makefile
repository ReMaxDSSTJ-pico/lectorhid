#
# Makefile for 'lectorhid'
# 2019 Tod E. Kurt, todbot.com
# 2024 Pedro Farias, tjactivo@hotmail.com
#
...
CFLAGS += -DLECTORHID_VERSION=\"$(LECTORHID_VERSION)\"
CFLAGS += -g
CFLAGS += -Wall
OBJS += lectorhid.o
...
lectorhid: $(OBJS)
	$(CC) $(CFLAGS) $(OBJS) -o lectorhid$(EXE) $(LIBS)

clean:
	rm -f $(OBJS)
	rm -f lectorhid$(EXE)

package: lectorhid$(EXE)
	@echo "Packaging up lectorhid for '$(OS)-$(ARCH)'"
	zip lectorhid-$(OS)-$(ARCH).zip lectorhid$(EXE)
